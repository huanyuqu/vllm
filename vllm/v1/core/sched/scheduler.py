...
class Scheduler(SchedulerInterface):
    def __init__(
        ...
        self.kv_cache_manager = KVCacheManager(
            ...
            enable_semantic_segment=self.cache_config.enable_semantic_segment_memory_management,
    ...
    def pop_pending_semantic_memory_ops(
        ...
        """Pop pending semantic memory moves/swaps generated by consolidation."""
        if not self.cache_config.enable_semantic_segment_memory_management:
            return [], []
        return self.kv_cache_manager.get_pending_moves()
